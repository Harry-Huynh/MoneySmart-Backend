...
module.exports.addTransaction = async function (userId, transactionData) {
  ...
  ...(await checkGoalAndBuildNotifications({ userId, savingGoalId: trans.savingGoalId, t })),
];
...
module.exports.deleteTransaction = async function (userId, transactionId) {
  ...
  ...(await checkGoalAndBuildNotifications({ userId, savingGoalId: deleteTrans.savingGoalId, t })),
];
...
module.exports.updateTransaction = async function (userId, transactionId, newTransactionInfo) {
  ...
  ...(await checkGoalAndBuildNotifications({ userId, savingGoalId: updatedTransaction.savingGoalId, t })),
];
